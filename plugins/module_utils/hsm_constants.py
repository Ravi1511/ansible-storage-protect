...
class HSMConstants:
    ...
    # DSMC binary locations by platform
    DSMC_PATHS = {
        'linux': [
        ...
        'windows': [
            ...
            'C:\\Program Files (x86)\\Tivoli\\TSM\\baclient\\dsmc.exe',
            'dsmc.exe'  # Fallback to PATH
        ]
    }
    ...
    CONFIG_PATHS = {
        ...
        'windows': {
            'dsm_opt': 'C:\\Program Files\\Tivoli\\TSM\\baclient\\dsm.opt',
            'config_dir': 'C:\\Program Files\\Tivoli\\TSM\\baclient'
        }
    }
